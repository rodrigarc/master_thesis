...
knitr::opts_knit$set(root.dir = "R:/Mestrado ERASMUS/M4 Internship/Programming/Raw_data")
...
sf <- summarise.abi.folder("R:/Mestrado ERASMUS/M4 Internship/Programming/Raw_data/sanger_LC/",
...
mapply(FUN = secondary.peaks, 
       ...
       MoreArgs = list(output.folder = "/Users/rodri/Desktop/sanger_LC/quality_reports/200306/secondary_peaks/", ratio = 0.5))
...
rmarkdown::render("/Users/rodri/Desktop/sanger_LC/code/sanger_LC-06-04-2020.rmd",
                  output_file = paste("LC","_","report_", '_', Sys.Date(), ".html", sep = ""), 
                  output_dir = "/Users/rodri/Desktop/sanger_LC/quality_reports/200306")
getwd()
...
lc <- read.csv("/Users/rodri/Desktop/sanger_LC/quality_reports/200306/sanger_filtered.csv")
lc <- lc %>% select(sample, sequence)
lc$sample <- as.character(lc$sample)
lc$sequence <- as.character(lc$sequence)

dataframe2fas(lc, file = "/Users/rodri/Desktop/sanger_LC/quality_reports/200306/LCpX.fasta")
