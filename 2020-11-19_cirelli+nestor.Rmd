...
tree <- treeio::read.tree("~/Box Sync/RSV NGS/RSV/germline_dbs/Nestor_db/V_nestor-NL_and_NGCS_muscle.tre")
...
g2
ggsave("~/Box Sync/RSV NGS/RSV/germline_dbs/Nestor_db/NL_NGC_tree.pdf",
