...
write.xlsx(list_of_datasets, file = "chao_datasets.xlsx")

list_summary <- lapply(unlist(list_estimators), as.numeric)
list_summary <- lapply(list_estimators, base::mean, na.rm)

#list exported to excel and average per animal calculated there
