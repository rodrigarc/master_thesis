...
#write.csv(ndf_s, "~/Box Sync/public_repertoire/results/2020-09-13/public-tables/2020-08-16_public-table-combined.csv",
row.names = F, quote = F)
...
#write.csv(new_df,
          "~/Box Sync/public_repertoire/results/2020-09-13/public-tables/2020-09-13_public-clones-sc-rep-sc.csv",
          row.names = F)
...
#ggsave("~/Box Sync/RSV NGS/v4_Analysis/v4_public-repertoire/analysis/v4/results/2020-09-13/figures/2020-09-13_public-clones-IgM-B1-B2+lines.tiff",
       height = 3.5,
       width = 5,
       dpi = 200,
       bg = "transparent")

minors<-seq(1.5,234,by=1)
minors
...
ggsave("~/Box Sync/public_repertoire/results/2020-09-13/figures/2020-08-17_all-public-clones-IgM-B1-B2.tiff",
       height = 7,
       width = 12,
       dpi = 200,
       bg = "transparent")
